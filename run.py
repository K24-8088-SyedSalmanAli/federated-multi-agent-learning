# """
# Federated Multi-Agent Learning — Unified Runner
# ================================================
# Single entry point for all weeks.

# Usage:
#     python run.py --week 8                          # Week 8: Local IDS Training
#     python run.py --week 9                          # Week 9: Federated Learning
#     python run.py --week 8 --epochs 10              # Quick test
#     python run.py --week 9 --rounds 5 --epochs 3    # Quick test
#     python run.py --week all                        # Run everything
# """
...
#     parser.add_argument("--week", type=str, required=True, help="Week to run: 8, 9, or all")
#     parser.add_argument("--raw-dir", default="data/raw")
#     parser.add_argument("--processed-dir", default="data/processed")
#     parser.add_argument("--results-dir", default="data/results")
#     parser.add_argument("--epochs", type=int, default=30, help="Training epochs")
#     parser.add_argument("--rounds", type=int, default=10, help="Federated rounds (Week 9)")
...
#         run_week9(args)
#     else:
#         print(f"Unknown week: {args.week}. Use 8, 9, or all.")
#         sys.exit(1)
...
## week 8 summary:
# The proposed federated IDS framework successfully processed over 2.2 million samples and completed 
# full training (local + centralized) in approximately 1.8 hours using GPU acceleration, achieving up to ~20× speedup compared to CPU execution.
...
# ----------------------------------------------------------------------
# FedAvg (Baseline)                0.9935   0.9952   0.9616   0.9781   0.9996
# Coordinate Median (Proposed)     0.9263   0.7939   0.6893   0.7379   0.8751

# Round      FedAvg Acc   Median Acc
# --------------------------------
# 1              0.9702       0.2518
# 2              0.9915       0.9127
# 3              0.9924       0.9536
...
# Reputation Scores:
#   Supplier_RawMaterials: 100/100 ✓
#   Supplier_Components: 100/100 ✓
#   Manufacturer_Assembly: 100/100 ✓
#   Logistics_Provider: 100/100 ✓
#   OEM_Distributor: 100/100 ✓
# ======================================================================

# Total time: 264394.1s
# Results saved to: data/results/

# Dekh kya prove hua:
# Untargeted Attack (noise injection):

# No Defense = 84.94% (model destroy ho gaya)
# Full Defense = 97.77% (defense ne bacha liya!)

# Full Defense har scenario mein 96%+ accuracy maintain kar raha hai — ye thesis mein bohat strong result hai.
# Key finding: Bina defense ke untargeted attack model ko 84% pe gira deta hai, lekin Coordinate Median + Gradient Clipping lagane se 97%+ accuracy rehti hai. Defense kaam kar raha hai!
# Ab Week 11 + 12 lagao — dono fast hain. Week 11 + 12 ka code ready hai?
...
# def main():
#     parser = argparse.ArgumentParser(description="Federated Multi-Agent Learning")
#     parser.add_argument("--week", type=str, required=True, help="Week to run: 8, 9, 10, or all")
#     parser.add_argument("--raw-dir", default="data/raw")
#     parser.add_argument("--processed-dir", default="data/processed")
#     parser.add_argument("--results-dir", default="data/results")
#     parser.add_argument("--epochs", type=int, default=30, help="Training epochs")
...
#         run_week10(args)
#     else:
#         print(f"Unknown week: {args.week}. Use 8, 9, 10, or all.")
#         sys.exit(1)
